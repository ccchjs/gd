...
<?php endif; ?>
            ...
            <div class="mt-6 flex justify-end">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['href' => ''.e(route('logout')).'','xOn:click' => '$dispatch(\'close\'), document.getElementById(\'logout-form\').submit();']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('logout')).'','x-on:click' => '$dispatch(\'close\'), document.getElementById(\'logout-form\').submit();']); ?>">
...
<?php /**PATH C:\xampp\htdocs\guidance2\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>