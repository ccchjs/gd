                ...
                <tbody class="text-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-100">
                            <td class="border py-2 px-4 text-center"><?php echo e($role->name); ?></td>
                            <td class="border py-2 px-4 text-center">
                                <div class="flex justify-end">
                                <a href="<?php echo e(url('Roles.edit/' . $role->id)); ?>" class="bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold py-2 px-2 rounded-lg focus:outline-none focus:shadow-outline mr-2">Edit</a>
                                <form action="<?php echo e(url('Roles.delete/' . $role->id)); ?>" method="POST" onsubmit="return confirm('Are you sure?');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\guidance2\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>